...
class mainWindow(wx.Frame):
    def __init__(self, parent, title):
        ...
        labelLigarPiscas = wx.StaticText(self, label="Ligar os piscas", pos=(400, 190), style=wx.ALIGN_CENTER)
        ...
        fontToLabelLigarPiscas = wx.Font(14, wx.DEFAULT, wx.NORMAL, wx.BOLD)
        ...
        labelLigarPiscas.SetFont(fontToLabelLigarPiscas)
        ...
        buttonCarPiscasEsq = wx.Button(self, pos=(430, 210), size=(50, 30), id=wx.ID_ANY, label="Esquerda") #FALTA A ACCAO PARA O BOTAO
        buttonCarPiscasTodos = wx.Button(self, pos=(490, 210), size=(40, 30), id=wx.ID_ANY, label="Todos") #FALTA A ACCAO PARA O BOTAO
        buttonCarPiscasDrt = wx.Button(self, pos=(540, 210), size=(50, 30), id=wx.ID_ANY, label="Direita") #FALTA A ACCAO PARA O BOTAO
